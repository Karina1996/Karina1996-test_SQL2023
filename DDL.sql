...
CREATE TABLE ДоставкаЗаказа (	   
	...
	ПериодНачала datetime,								--допустим, начал в 9:00 (можно ставить статус: у курьера)
...
--добавлять таблицы: "Департаменты", "Элементы подкатегорий", "Параметры продукта", "Избранное",  "Договора", "Платежи", "Складкой учет", "Учет продаж" и т.д.
